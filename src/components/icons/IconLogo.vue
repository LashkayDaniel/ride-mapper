<template>
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
       color="currentColor">
      <path
        d="M14.5 9.5h.009M14.5 6C16.394 6 18 7.613 18 9.57c0 1.989-1.632 3.384-3.14 4.333a.72.72 0 0 1-.72 0C12.635 12.945 11 11.565 11 9.57C11 7.613 12.606 6 14.5 6" />
      <path
